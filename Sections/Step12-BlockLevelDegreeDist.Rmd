...
par(mfrow = c(1,1))
ggplot(bMeanDeg,aes(x=dates.Date)) + 
...
print(paste0("The block-level mean degree averaged across the days from ", 
             firstDay, " to ", lastDay, " is ", 
             round(bOverallMeanDeg, digits = 4), " edges per node."))
```
