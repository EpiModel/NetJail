...
cell_changes[2:17, 5:7] <- temp[, 2:4]
...
if (EstimateLocDurations == TRUE) {
  ...
  cLocDurations <- rbind(locDurations1, locDurations2, locDurations3, 
                        locDurations4)
  ...
  print(knitr::kable(cLocDurations[cLocDurations$category == "Overall", ]))
